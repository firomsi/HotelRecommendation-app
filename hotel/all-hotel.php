		    ...
		    while($row = $result->fetch_assoc()) {   
		 		...
		 		<div class="hotel-list-item" style="text-align: center;overflow: hidden;height:300px;width:300px;">
					<a href="hotel.php?id=<?php echo $row['id']; ?>">
				 	...
				 	<?php
	if($_SESSION['role']=='admin'){?><a href="hoteledit.php?id=<?php echo $row['id']; ?>" style="background-color:#bdc3c7;color:white;display:block;width:130px;float:left;padding:5px 10px;">Edit</a><a style="background-color:#bdc3c7;color:white;display:block;width:130px;float:left;padding:5px 10px;" href="hoteldelete.php?id=<?php echo $row['id']; ?>">Delete</a><?php }
	?>
			 	</div>
